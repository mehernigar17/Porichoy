...
class _SscpageState extends State<Sscpage> {
  ...
  ?  "মূল এসএসসি সনদপত্র এবং মার্কশিট।\n\n"
      "অনলাইন রেজিস্ট্রেশন/রোল নম্বর ও রেজিস্ট্রেশন কার্ডের কপি।\n\n"
      ...
      : "Original SSC certificate and mark sheet.\n\n"
  ...
  "অনেক ক্ষেত্রে অনলাইনের মাধ্যমে আবেদন করা যায় শিক্ষা বোর্ডের অফিসিয়াল ওয়েবসাইটে।\n\n"
      "প্রয়োজনে সরাসরি বোর্ড অফিসে উপস্থিত হতে হতে পারে।\n\n"
  ...
  "content": appState.isBangla
  ? "ভুল বানানে নাম সংশোধনের আবেদন করা কিন্তু সঠিক প্রমাণপত্র না দেওয়া।\n\n"
      ...
      "Missing the official deadline for correction application.\n\n"

  },
  {
  "title": appState.isBangla ? "প্রয়োজনীয় পূর্বশর্ত" : "Prerequisites",
  "content": appState.isBangla
  ? "আবেদনকারীকে সংশ্লিষ্ট শিক্ষা বোর্ডের অধীনে এসএসসি পরীক্ষায় উত্তীর্ণ হতে হবে।\n\n"
      "ভুল তথ্যের সঠিক প্রমাণপত্র থাকতে হবে।\n\n"
      "বোর্ড নির্ধারিত সময়ের মধ্যে আবেদন করতে হবে।\n\n"
      "নির্ধারিত সংশোধন ফি পরিশোধ করতে হবে।\n\n"
      : "The applicant must have passed the SSC examination under the respective Education Board.\n\n"
  ...
  context,
  MaterialPageRoute(
  builder: (context) => const sscFormFillPage(),
  ),
  );
  },
  child: Container(
