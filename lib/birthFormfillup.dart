...
const String _formId = 'birth_registration';
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          focusedErrorBorder: const OutlineInputBorder(borderSide: BorderSide(color: Colors.green, width: 2)),
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          isBangla ? "জন্ম নিবন্ধনের জন্য আবেদন" : "Application for Birth Registration",
          style: isBangla
