...
import 'package:porichoy/birthcorrectform.dart';
import 'package:provider/provider.dart';
import 'appstate.dart';

class BirthCorrectionPage extends StatefulWidget {
  const BirthCorrectionPage({super.key});

  @override
  State<BirthCorrectionPage> createState() => _BirthCorrectionPageState();
}

class _BirthCorrectionPageState extends State<BirthCorrectionPage> {
          ...
          child: Padding(
            ...
            child: Column(
                children: [
                  ...
                  Text(isBangla?
                  "জন্ম নিবন্ধন সংশোধন সংক্রান্ত তথ্য": "Information regarding birth registration correction",
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Birthcorrectform(),
                        ),
                      );
                    },
                    child: Container(
